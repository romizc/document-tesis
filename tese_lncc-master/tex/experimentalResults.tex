...
\begin{figure}[h]
	...
	\caption{Example of a fitted ARIMA forecast with prediction intervals.}
	% Change caption.
...
For the experiment we also compute the elapsed time for training the models for all the elements in the domain, by doing that we are able to quantify %cuanto tiempo a menos seria usado en la metodologia propuesta. 
