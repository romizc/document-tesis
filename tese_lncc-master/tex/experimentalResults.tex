...
We implement the architectures in \texttt{keras} (\cite{Chollet2015}),  considering the following CNN1D-LSTM, a 10 layer neural network formed by 2 CNN1D layers, 2 LSTM layers and 1 Dense layer:
