...
We consider the existence of several competing models for different regions of the dataset 
...
\item[Chapter 4.] \textbf{[Methodology.]} This chapter is dedicated to elaborating in detail the methodology proposed in this work, providing justifications for some of the decisions made and establishing hypothesis that can be later validated via experiments.

\item[Chapter 5.] \textbf{[Spatio Temporal Tool for Time Series Analysis.]} Describes some architectural aspects of an application designed to implement the proposed methodology and to perform the experiments aimed at validating our proposal.
